...
import en.pre.android.validsig.actions.wifi.WifiConnector
import en.pre.android.validsig.activity.MainActivity
import en.pre.android.validsig.adapter.prettifyFormatName
import en.pre.android.validsig.app.*
import en.pre.android.validsig.content.shareText
import en.pre.android.validsig.content.toHexString
import en.pre.android.validsig.database.Recreation
import en.pre.android.validsig.database.Scan
import en.pre.android.validsig.database.toRecreation
import en.pre.android.validsig.io.askForFileName
import en.pre.android.validsig.io.toSaveResult
...
class DecodeFragment : Fragment() {
	...
	private var action = en.pre.android.validsig.actions.ActionRegistry.DEFAULT_ACTION
	...
	private fun resolveActionAndUpdateFab(bytes: ByteArray) {
		...
		if (!prevAction.canExecuteOn(bytes)) {
			action = en.pre.android.validsig.actions.ActionRegistry.getAction(bytes)
		}
